...
import { ChatItem, MessageItem, UserItem, ParticipantInfoItem, ChatDetailsParams } from '../types';
...
export default function ChatDetails() {
  ...
  const params = route.params as ChatDetailsParams;
  const { 
    id,
    participants, 
    participantsInfo, 
  ...
  const [messages, setMessages] = useState<MessageItem[]>(messagesReceived);
